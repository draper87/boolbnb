    ...
    <main>
            ...
            <div class="row">
                ...
                <div class="absolute d-none d-lg-block">
                    <form class="form-inline mr-auto">
                        <input class="form-control mr-sm-2" type="text" placeholder="Dove andiamo?"
                               aria-label="Dove andiamo?">
        ...
        <section>
            <div class="container-fluid relat">
                ...
                <!-- IMAGE CAROUSEL BASE -->
                <div id="multi-item-example" class="carousel slide carousel-multi-item title_space_around"
                     data-ride="carousel">
                    <!--CONTROL LEFT-->
                        ...
                        <div class="carousel-item active">
                            <div class="col-md-3 my_shadow " style="float:left">
                                ...
                                <div class="card mb-2">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Milano</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Torino</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Bergamo</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Genova</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Lodi</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Napoli</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Roma</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
                            ...
                            <div class="col-md-3 my_shadow" style="float:left">
                                ...
                                <div class="card mb-2">
                                    <img class="card-img-top relative"
                                         src="{{asset('images/casa.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title text-center">Cantù</h4>
                                        <p class="card-text">Ho scritto del testo a caso tanto per fare spessore nel
                                            contenuto della card, quindi ciao!</p>
                                        <a class="btn btn-success spacing_my">Guarda ora</a>
                                    </div>
        ...
        <section>
            <div class="container get_away_from_me">
                ...
                <div id="multi-item-example" class="carousel slide carousel-multi-item get_away_from_me"
                     data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <!--FIRST PAGE-->
                        <div class="carousel-item active">
