            ...
            <div class="row no-gutters">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="ms_single_message">
                        ...
                        <div class="row">
                            <div
                                class="col-12 offset-md-4 col-md-8 offset-md-7 col-md-5 offset-lg-9 col-lg-3 offset-xl-9 col-xl-3">
                                <a href="{{route('admin.message')}}" class="btn btn-info">Torna alla pagina dei
                                    messaggi</a>
                            </div>
                        </div>
                    </div>
