                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ms_messaggio_linea">
                            ...
                            @foreach ($apartment->messages as $message)
                                <div class="row no-gutters ms_messaggio">
                                    ...
                                    <!-- bottoni -->
                                    <div
                                        class="col-2 offset-2 col-sm-2 offset-sm-0 col-md-2 offset-md-0 col-lg-1 offset-lg-1 col-xl-1 offset-xl-1 ">
                                        <a class="btn btn-success"
                                           href="{{route('admin.message_show' , $message->id)}}"><i
                                    ...
                                    <div class="col-2 col-sm-2 col-md-2 col-lg-1 col-xl-1">
                                        <form action="{{route('admin.message_detroy', $message->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger" type="submit" name="" value="Elimina">
