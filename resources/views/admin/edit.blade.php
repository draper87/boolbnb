                        ...
                        <!-- inizio righe titolo e camere -->
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" type="text" name="title" placeholder="Titolo"
                                           value="{{ isset($apartment->title)? $apartment->title : old('title')}}"
                                           required>
                                </div>
                                <div class="col-lg-6">
                                    <label for="rooms">Stanze</label><br>
                                    <input class="form-control" type="number" name="rooms" placeholder="Stanze"
                                           value="{{ isset($apartment->rooms)? $apartment->rooms : old('rooms')}}"
                                           required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" type="number" name="beds" placeholder="Letti"
                                           value="{{ isset($apartment->beds)? $apartment->beds : old('beds')}}"
                                           required>
                                </div>
                                <div class="col-lg-6">
                                    <label for="bathrooms">Bagni</label><br>
                                    <input class="form-control" type="number" name="bathrooms" placeholder="Bagni"
                                           value="{{ isset($apartment->bathrooms)? $apartment->bathrooms : old('bathrooms')}}"
                                           required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <input class="form-control" type="number" name="square" placeholder="Metri quadri"
                                           value="{{ isset($apartment->square)? $apartment->square : old('square')}}"
                                           required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <textarea class="form-control" type="text" name="descrizione"
                                              placeholder="Descrizione"
                                              required>{{ isset($apartment->descrizione)? $apartment->descrizione : old('descrizione')}}</textarea>
                                </div>
                            </div>
                            <!-- fine descrizione-->
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <input class="form-control" id="address" type="text" name="address"
                                           ...
                                           value="{{ isset($apartment->address)? $apartment->address : old('address')}}"
                                           required>
                                </div>
                            </div>
                            <!-- fine riga indirizzo -->
                            ...
                            <div class="form-group row" hidden>
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" id="lng-value" type="text" name="longitude"
                                           placeholder="Longitude"
                                           value="{{ isset($apartment->longitude)? $apartment->longitude :old('longitude')}}"
                                           required>
                                </div>
                                <div class="col-lg-6">
                                    <label for="latitude">Latitude</label><br>
                                    <input class="form-control" id="lat-value" type="text" name="latitude"
                                           placeholder="Latitude"
                                           value="{{ isset($apartment->latitude)? $apartment->latitude :old('latitude')}}"
                                           required>
                                </div>
                            </div>
                                ...
                                @foreach ($facilities as $facility)
                                    ...
                                    <div class="offset-lg-1 col-lg-3">
                                        ...
                                        <label class="text-capitalize"
                                               for="facilities[]">{{ $facility->facility }}</label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <input type="checkbox" name="visible"
                                           {{ ($apartment->visible) ? '' : 'checked' }} value="check">
